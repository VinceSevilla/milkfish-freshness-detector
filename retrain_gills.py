"""
Retrain ONLY the gills model with white-balance corrected data
"""
import os
import sys
import numpy as np
...
class GillsModelRetrainer:
    """Retrain gills model with corrected data"""
    ...
    def extract_hybrid_features(self, images, use_augmentation=False):
        ...
        for img in images:
            ...
            # Flatten all 29 features (3 scales x 6 props + 1 basic scale x 5 props)
            features = []
            ...
            # If more or less than 18 features, pad or trim (should be 18 for 3 scales)
            features = features[:18] + [0.0]*(18-len(features))
            # Add 11 more features if needed to reach 29 (legacy: sometimes extra props or scales)
    ...
    def train(self):
        """Train gills model"""
        print("\n" + "="*60)
        print("RETRAINING GILLS MODEL WITH WHITE BALANCE CORRECTION")
        print("="*60)
        ...
        # Save model
        output_path = self.output_dir / 'best_model_gills.h5'
